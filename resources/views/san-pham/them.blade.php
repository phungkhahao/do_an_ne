        ...
        <form id="frm-them-san-pham" data-parsley-validate>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 mb-3">
                    ...
                    <input type="text" class="form-control" name="ma" required data-parsley-required-message="Vui lòng nhập mã sản phẩm">
                </div>
                <div class="col-md-6 col-sm-12 mb-3">
                    <label class="form-label">Tên sản phầm</label>
                    <input type="text" class="form-control" name="ten" required data-parsley-required-message="Vui lòng nhập tên sản phẩm">
                </div>
                <div class="col-md-12 col-sm-12 mb-3">
                    <label class="form-label">Mô tả</label>
                    <textarea type="text" class="form-control" name="mo_ta" required data-parsley-required-message="Vui lòng nhập mô tả sản phẩm"></textarea>
                </div>
            </div>
