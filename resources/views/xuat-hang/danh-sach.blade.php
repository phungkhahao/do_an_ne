...
<div class="card d-flex ">
    <div class="card-body">
        <div class="d-lg-flex justify-content-end mb-3">
            <a href="{{ route('xuat_hang.create') }}" id="btn-them-moi" class="btn btn-primary mt-2 mt-lg-1 ms-3">
                <i class="bx bxs-plus-square"></i>Thêm mới
            </a>
        </div>
        <div class="table-responsive">
            <table id="xuat-hang" class="table table-bordered cus-talbe">
                ...
                <tbody>
                    ...
                    @foreach($dsHoaDonXuat as $hoaDonXuat)
                    <tr>
