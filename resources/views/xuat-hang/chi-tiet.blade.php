    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-3 col-sm-12 mb-2">
                <h5 style="font-size: 14px">Mã đơn xuất: <span>{{ $donHang->ma_don_xuat }}</span></h5>
                <h5 style="font-size: 14px">Ngày xuất: <span>{{ \Carbon\Carbon::parse($donHang->ngay_xuat)->format('d/m/Y')  }}</span></h5>
