...
<div class="card d-flex ">
    <div class="card-body">
        <form id="frm-them-hoa-don-xuat" data-parsley-validate>
            @csrf
            <div class="row">
                <div class="col-md-6 col-sm-12 mb-3">
                    <label class="form-label">Ngày xuất</label>
                    <input type="date" class="form-control" name="ngay_xuat" required data-parsley-required-message="Vui lòng nhập ngày" value="{{  \Carbon\Carbon::now()->format('Y-m-d') }}">
                </div>
                <div class="col-md-6 col-sm-12 mb-3">
                                ...
                                <div class="col-md-4">
                                    <select class="form-select mb-3 san-pham select-san-pham"
                                        ...
                                        @foreach ($dsKhoHang as $KhoHang)
                                            ...
                                            <option value="{{ $KhoHang->id }}">{{ $KhoHang->san_pham->ten }} ({{ "DX".str_pad($KhoHang->idNhapHang, 8, "0", STR_PAD_LEFT) }})</option>
                                        @endforeach
                                    </select>
...
<script>
    ...
    $('#btn-submit-form').click(function() {
        if($('#frm-them-hoa-don-xuat').parsley().validate()) {
